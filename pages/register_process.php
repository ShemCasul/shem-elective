...
$testedPassword = test_input($password);
$testedConfirmationPassword = test_input($confirmationPassword);
...
} elseif ($testedPassword !== $testedConfirmationPassword) {
    $title = "Wrong Confirmation Password !";
    $message = "The passwords you entered do not match.";
    $alertClass = "alert-danger";
} elseif (!preg_match($regex, $testedPassword)) {
